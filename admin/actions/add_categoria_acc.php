...
try {
    ...
    Alerta::agregar_alerta('success', "La categoría se agregó correctamente");

} catch (Exception $e) {
    Alerta::agregar_alerta('danger', "Hubo un error y no se pudo agregar la categoría. Para solucionarlo, contactate con el administrador del sistema");
}
